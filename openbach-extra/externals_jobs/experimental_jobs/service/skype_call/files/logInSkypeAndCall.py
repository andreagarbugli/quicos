...
def launch(cmd):
	...
	#print (current_windows())
	#print("\n \n \n")
	#print (open_windows == current_windows())
	#print(sameList(open_windows, current_windows()))
...
def main(sim_t, Id):
	...
	sleep(10)#Wait for the graphical interface to be set
	x,y = win_pos(wid)
	print ("We're moving...")
	open_windows = current_windows()
	...
	if (Id == 1):
		Keyboard.type("h714221@mvrht.net")
	elif (Id == 2):
		Keyboard.type("j310562@mvrht.net")
	elif (Id == 3):
		Keyboard.type("j311846@mvrht.net")
	#Continue
	sleep(0.2)
	subprocess.call("xdotool windowactivate {0}".format(wid), shell=True)#Set the right window on the foreground
	...
	xreceiver = 50
	yreceiver = 250
	Mouse.position = x + xreceiver,y + yreceiver
	Mouse.press(mouse.Button.right)
	Mouse.release(mouse.Button.right)
	sleep(0.5)
	subprocess.call("xdotool windowactivate {0}".format(wid), shell=True)#Set the right window on the foreground
	Mouse.position = x + xreceiver,y + yreceiver + 50
	...
	subprocess.call("xdotool windowactivate {0}".format(wid), shell=True)#Set the right window on the foreground
	Mouse.position = x + width/2 + 60,y + height - 50
	Mouse.press(mouse.Button.left)
	Mouse.release(mouse.Button.left)
