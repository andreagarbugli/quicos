            ...
            while True:
                ...
                try:
                    ...
                    if name == 'ping':
                        ...
                        collect_agent.send_stat(timestamp, stat2=value)
...
if __name__ == '__main__':
    with collect_agent.use_configuration("/opt/openbach/agent/jobs/container_run_client"
                                         "/container_run_client_rstat_filter.conf"):
